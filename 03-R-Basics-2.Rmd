...
```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("images/liste.png")
```
...
```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("images/liste_von_vektoren.png")
```
...
```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("images/wickham-train.png")
knitr::include_graphics("images/wickham-train-single.png")
```
```{r, echo = FALSE, out.width = NULL, fig.cap = "Quelle: Hadley Wickham (2019),  https://adv-r.hadley.nz/subsetting.html#subset-single"}
knitr::include_graphics("images/wickham-train-multiple.png")
```
...
```{r, echo = FALSE, out.width = NULL, fig.cap = "Hadley Wickham (2019), https://adv-r.hadley.nz/names-values.html#binding-basics"}
