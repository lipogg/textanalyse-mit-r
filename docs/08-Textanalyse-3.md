...
tstat_subset <- tstat_freq_grouped[grepl("tochter", tstat_freq_grouped$feature), ]
tstat_subset
```
...
Die Häufigkeit der "tochter"-Tokens wird anschließend visualisiert: 
