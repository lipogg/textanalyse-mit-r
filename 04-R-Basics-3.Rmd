...
begriffe <- c("Anweisungsblock", "Iteration", "Iterieren", "Terminieren")
englisch <- c("Code block", "Iteration", "Iterate", "Terminate")
definitionen <- c(
  "Mehrere aufeinanderfolgende Codezeilen, zum Beispiel im Körper einer Schleife oder einer bedingten Anweisung.",
  "Im Kontext von Kontrollstrukturen bezeichnet Iteration zwei Dinge: in einem allgemeinen Sinn den Prozess, bei dem Anweisungen wiederholt ausgeführt werden, und zum anderen einen einzigen Schleifendurchlauf, also das einmalige Ausführen der Anweisungen im Schleifenkörper. Wenn der Code einmal ausgeführt wird, sagt man entsprechend 'eine Iteration', für das zweimalige Ausführen 'zwei Iterationen', usw.",
  "Wenn beschrieben werden soll, dass eine for-Schleife ein Objekt durchläuft, wird dazu häufig gesagt, dass die Schleife 'über das Objekt iteriert'.",
  "Wenn eine Schleife terminiert bedeutet das, dass sie die Ausführung beendet; sie kommt zum Ende."
  )  
