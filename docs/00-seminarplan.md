...
|:-----------|:-----------------|:-----------------------------------------------------------------|
|1           |14.10.            |Einstieg                                                          |
|2           |21.10.            |R Basics I: Datentypen, Variablen und Operatoren                  |
|3, 4        |28.10. und 04.11. |R Basics II: Datenstrukturen                                      |
|5           |11.11.            |R Basics III: Kontrollstrukturen                                  |
|6           |18.11.            |R Basics IV: Funktionen und Pakete                                |
|7           |25.11.            |R Basics Wiederholung                                             |
|8           |02.12.            |Textanalyse mit Quanteda I: Korpus, Tokens, Daten und Dateien     |
|9           |09.12.            |Textanalyse mit Quanteda II: Preprocessing und Reguläre Ausdrücke |
|10, 11      |16.12. und 06.01. |Textanalyse mit Quanteda III: Wortfrequenzanalysen                |
|12          |13.01.            |Part of Speech Tagging und Dependency Parsing mit UDPipe          |
|13          |20.01.            |Textanalyse Wiederholung                                          |
|14          |27.01.            |Named Entity Recognition                                          |
|15, 16      |03. und 10.02.    |Arbeit mit XML-TEI Dateien: XML, TEI und XPath                    |
